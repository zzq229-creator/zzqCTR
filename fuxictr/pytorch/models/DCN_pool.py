...
from fuxictr.pytorch.layers import EmbeddingLayer, MLP_Layer, CrossNet, PoolLayer


class DCN_pool(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="DCN",
                 gpu=-1,
                 ...
                 **kwargs):
        super(DCN_pool, self).__init__(feature_map,
                                       model_id=model_id,
                                       gpu=gpu,
        ...
        input_dim = embedding_dim * (feature_map.num_fields + num_cluster)
    ...
    def forward(self, inputs):
        ...
        flat_feature_emb = all_emb.flatten(start_dim=1)
