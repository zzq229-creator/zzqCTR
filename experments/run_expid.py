...
sys.path.append('/home/guowei/zzq/zzqCTR/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='demo_config', help='The config directory.')
    parser.add_argument('--expid', type=str, default='DNN_pool_avazu', help='The experiment_id to run.')
    ...
    train_gen, valid_gen = datasets.h5_generator(feature_encoder, stage='train', **params)
    ...
    test_gen = datasets.h5_generator(feature_encoder, stage='test', **params)
